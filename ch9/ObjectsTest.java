...
public class ObjectsTest {
	public static void main(String[] args) {
		...
		System.out.println("depplequals(str2D, str2D_2) = "+Objects.deepEquals(str2D, str2D_2));
		...
		Comparator c = String.CASE_INSENSITIVE_ORDER; //대소문자 구분없음
		
		System.out.println("compare(\"aa\", \"bb\") = "+compare("aa", "bb", c));
		System.out.println("compare(\"bb\", \"aa\") = "+compare("bb", "aa", c));
		System.out.println("compare(\"ab\", \"AB\") = "+compare("ab", "AB", c)); //대소문자 구분 x
